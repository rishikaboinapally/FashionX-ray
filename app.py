...
feature_list = np.array(pickle.load(open(r'C:\Users\rishika\anaconda3\Scripts/embeddings.pkl', 'rb')))
filenames = pickle.load(open(r'C:\Users\rishika\anaconda3\Scripts/filenames.pkl', 'rb'))
