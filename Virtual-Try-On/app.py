    ...
    with gr.Row():
        ...
        with gr.Column():
            gr.HTML(
                ...
                <div>
                    <h3>Models are pre-set and cannot be uploaded or altered; however, users can upload their own garments.</h3>
                    <h4 style="margin: 0;">If your dress is a single piece, please proceed by uploading the image to the 'top garment' section and leave the 'lower garment' section empty.</h4>
                </div>
                </div>
                """)
            with gr.Row():
